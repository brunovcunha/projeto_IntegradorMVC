window.addEventListener("load", function () {
    document.body.style.backgroundImage = `url("/img/cenario/castelo.png")`;
    function acao(jogada) {
        ...
        if (jogada === 1 && jogadaInimigo === 3) {
            ...
            imgJogador1.src = "/img/cavaleiro_ataque.png";
            imgJogador2.src = "/img/cavaleiro_descansa.png";
        } else if (jogada === 3 && jogadaInimigo === 1) {
            resultadoTexto.innerHTML = "Derrota";

            imgJogador1.src = "/img/cavaleiro_descansa.png";
            imgJogador2.src = "/img/cavaleiro_ataque.png";

        } else if (jogada === 1 && jogadaInimigo === 2) {
            resultadoTexto.innerHTML = "Defendeu";

            imgJogador1.src = "/img/cavaleiro_ataque.png";
            imgJogador2.src = "/img/cavaleiro_defesa.png";
        }
        else if (jogada === 2 && jogadaInimigo === 1) {
            resultadoTexto.innerHTML = "Defendeu";

            imgJogador1.src = "/img/cavaleiro_defesa.png";
            imgJogador2.src = "/img/cavaleiro_ataque.png";
        }
