...
public class PartidaDao {
    ...
    public void inserirPartida(Partida partida) {
        ...
        data.update(sql, partida.getDuracao(), partida.getPontos_obtidos(), partida.getJogador(), partida.getCenario());
    }
    ...
    public void updatePartida(Partida partida) {
        ...
        data.update(sql, partida.getDuracao(), partida.getPontos_obtidos(), partida.getJogador(), partida.getCenario(), partida.getId_partida());
    }
